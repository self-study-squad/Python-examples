...
# sort items of any type for which a "less-than" relation (formally, a total order)
# is defined. Inefficient implementations it is not a stable sort, meaning that the
# relative order of equal sort items is not preserved. Quicksort can operate in-place
